...
const API_URL = "https://script.google.com/macros/s/AKfycbzgJmWi13uPTVzfAN4dxWY36KXGuhdeqhS4lY69jl_hqNf2wkjjDvC5142u4Z8xYUcj/exec";

/* ---------- MOCK DATA (edítalo según necesites) ---------- */

const services = [
  { id: 's1', title: 'MANICURA TRADICIONAL', desc: 'Limpieza, limado y esmaltado clásico para manos perfectas.', price: 25000, time: 40, category: 'servicio_clasico', popular: true },
  { id: 's2', title: 'SPA DE MANOS Y PIES', desc: 'Exfoliación, hidratación y masaje relajante con productos naturales.', price: 35000, time: 50, category: 'premium', popular: true, img: true },
  { id: 's3', title: 'PEDICURA PROFESIONAL', desc: 'Corte, limpieza y esmaltado con acabado duradero.', price: 30000, time: 45, category: 'servicio_clasico' },
  { id: 's4', title: 'UÑAS ACRÍLICAS', desc: 'Aplicación completa con forma y largo personalizado.', price: 60000, time: 90, category: 'premium' },
  { id: 's5', title: 'COLOR Y BRILLO', desc: 'Tintura completa, matizante y peinado final.', price: 70000, time: 75, category: 'premium' },
  { id: 's6', title: 'CEPILLADO EXPRESS', desc: 'Cepillado rápido con acabado natural.', price: 25000, time: 25, category: 'servicio_clasico' },
  { id: 's7', title: 'TRATAMIENTO CAPILAR', desc: 'Hidratación y reparación profunda del cabello.', price: 38000, time: 40, category: 'premium' },
  { id: 's8', title: 'MAQUILLAJE PROFESIONAL', desc: 'Maquillaje completo para eventos o sesiones fotográficas.', price: 80000, time: 60, category: 'premium' },
];


const collaborators = [
  { id:'c1', name:'Jessica', avatar:'images/barbero1.jpg' },
  { id:'c2', name:'Andrea', avatar:'images/barbero2.jpg' },
  { id:'c3', name:'Vanessa', avatar:'images/barbero3.jpg' },
];
...
function renderClientForm() {
  ...
  note.innerHTML = `Recuerda estar en camino <span style="color:#ff2dd5;font-weight:bold;">30 minutos</span> antes`;
